...
- `GET //dreams/:id` - Get a specific dream
- `POST //dreams` - Create a new dream (requires `dream_text` in body)
...
- `ANTHROPIC__KEY`: Your Anthropic  key
